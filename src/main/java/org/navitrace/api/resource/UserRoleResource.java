...
public class UserRoleResource extends BaseResource {
    ...
    public Response getSingle(@PathParam("id") long id) throws StorageException {
        Userrole entity = storage.getObject(Userrole.class, new Request(
    ...
    public Response getAll(@QueryParam("pageNo") int pageNo,
        ...
        Collection<Userrole> userroles = storage.getObjects(Userrole.class,
                new Request(new Columns.All(), new Order(sortField, desc, pageNo, pageSize)));
        return Response.ok(userroles).build();
    }

    @POST
    public Response add(Userrole entity) throws Exception {
    ...
    @Path("{id}")
    @PUT
    public Response update(Userrole entity) throws Exception {
    ...
    public Response remove(@PathParam("id") long id) throws Exception {
        storage.removeObject(Userrole.class, new Request(new Condition.Equals("id", id)));
