...
import org.navitrace.model.Vcategory;
...
public class VehicleCategoryResource extends BaseResource {

    @Path("{id}")
    @GET
    public Response getSingle(@PathParam("id") long id) throws StorageException {
        Vcategory entity = storage.getObject(Vcategory.class, new Request(
    ...
    public Response getAll(@QueryParam("pageNo") int pageNo,
        ...
        Collection<Vcategory> vcategories = storage.getObjects(Vcategory.class,
                new Request(new Columns.All(), new Order(sortField, desc, pageNo, pageSize)));
        return Response.ok(vcategories).build();
    }

    @POST
    public Response add(Vcategory entity) throws Exception {
    ...
    @Path("{id}")
    @PUT
    public Response update(Vcategory entity) throws Exception {
        storage.getObject(Vcategory.class, new Request(
    ...
    public Response remove(@PathParam("id") long id) throws Exception {
        storage.removeObject(Vcategory.class, new Request(new Condition.Equals("id", id)));
